  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Car Sharing Application: A sustainable future with shared mobility, driving efficiency and convenience into your everyday life."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Car Sharing Application: A sustainable future with shared mobility, driving efficiency and convenience into your everyday life.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Car Owner" type="car-owner" abilities={appConfig.ownerAbilities} />
