...
import { useRoqClient, useReportFindManyWithCount } from 'lib/roq';
...
export function ReportListPage(props: ReportListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useReportFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.report.delete({ where: { id } });
      await mutate();
    } catch (error) {
