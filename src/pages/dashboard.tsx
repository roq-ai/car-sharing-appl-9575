...
import { useBookingCount, useRatingCount, useCarCount } from 'lib/roq';

import { RatingListPage as ShowCaseList } from 'pages/ratings';
...
function DashboardPage() {
  ...
  const ratingStat = useRatingCount();
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`ratings`} passHref legacyBehavior>
                  <Button
